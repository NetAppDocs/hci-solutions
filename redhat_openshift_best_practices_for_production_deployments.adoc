...
summary: This section lists the following best practices for deploying this solution into production; deploy OpenShift to an RHV Cluster of at least three nodes, configure the virtual machine/host affinity, and use a custom install file for OpenShift deployment.
---
