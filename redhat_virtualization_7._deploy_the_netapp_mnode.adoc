...
summary: The management node (mNode) is a VM that runs in parallel with one or more Element software-based storage clusters. To install the NetApp mNode on Red Hat Virtualization, complete the steps listed on this page.
---
