...
keywords:
summary: A Deployment Jump VM running a Linux distribution is used for the following purposes; deploying ONTAP Select using an Ansible playbook, deploying the Kubernetes infrastructure with NVIDIA DeepOps and GPU Operator, and installing and configuring NetApp Trident.
---
